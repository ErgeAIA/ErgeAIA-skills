---
description: 定义中文和英文变更描述之间的翻译规则，确保双语文档一致性。
trigger-when: 双语言模式工作时，加载翻译规则和技术术语对照表
---
...
**中文文件 `CHANGELOG.md` 使用中文分类头；英文文件 `CHANGELOG.en.md` 使用英文分类头。**
...
- 此表是分类标题的**唯一真相源**；模板与 `+check` 必须与此一致。
- 禁止在中文文件写 `### Added`，也禁止在英文文件写 `### 新增`（历史遗留英文头由 `+check` 标 WARN，不强制改写已发布区块）。
...
- [ ] 版本号在两个文件中完全一致
- [ ] 日期格式相同（ISO 8601）
- [ ] 分类标题语言正确（中文文件中文头 / 英文文件英文头）且一一对应
- [ ] 条目数量一致
- [ ] 链接指向一致
- [ ] 技术术语保持原文
- [ ] 无截断或遗漏
