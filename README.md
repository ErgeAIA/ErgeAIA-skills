...
| [vibe-buddy](vibe-buddy/) | 项目 AI 协作记忆管理：把协作契约写进 AGENTS.md，把进度、决策、踩坑沉淀到 docs/.ai/，跨会话交接靠自包含文档（vibe-init / vibe-sync / vibe-handoff / vibe-resume / vibe-distill） | v1.0.0 |
