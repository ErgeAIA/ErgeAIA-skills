...
| 技能 | 说明 | 使用示例 | 版本 |
|------|------|----------|------|
| [skill-workshop](skill-workshop/) | Skill 质量工作站：创建、审计、**优化**、校验（四模式职责分离；Fast/Deep/Eval≡L0/L1/L2；Optimize 全量读取后真正重构并回归；CLI 只判结构，description 质量交语义评审） | `优化这个 skill：改完给我 Before/After` | v2.3.0 |
