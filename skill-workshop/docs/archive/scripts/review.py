...
Usage:
    python scripts/skill_cli.py review <workspace-path> [--port PORT] [--skill-name NAME]
    python scripts/skill_cli.py review <workspace-path> --previous-workspace /path/to/old/workspace
...
def generate_html(
    ...
    template_path = Path(__file__).resolve().parents[2] / "assets" / "eval_review.html"
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.static:
        ...
        args.static.write_text(html_out, encoding="utf-8")
