...
|-------|-------------|---------------|---------|
| [skill-workshop](skill-workshop/) | Skill quality workstation: create, audit, **optimize**, validate (four modes with separated duties; Fast/Deep/Eval ≡ L0/L1/L2; Optimize reads all runtime assets, actually rewrites and regression-checks; the CLI only checks structure — description quality is a semantic review) | `Optimize this skill and give me Before/After` | v2.3.0 |
